...
abstract class $SupportReplyModelCopyWith<$Res> {
  factory $SupportReplyModelCopyWith(
          SupportReplyModel value, $Res Function(SupportReplyModel) then) =
...
abstract class _$$SupportReplyModelImplCopyWith<$Res>
    implements $SupportReplyModelCopyWith<$Res> {
  factory _$$SupportReplyModelImplCopyWith(_$SupportReplyModelImpl value,
...
class __$$SupportReplyModelImplCopyWithImpl<$Res>
  ...
  __$$SupportReplyModelImplCopyWithImpl(_$SupportReplyModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$SupportReplyModelImpl(
      replyId: null == replyId
          ? _value.replyId
          : replyId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SupportReplyModelImpl extends _SupportReplyModel {
  ...
  @override
  String toString() {
    return 'SupportReplyModel(replyId: $replyId, postId: $postId, userId: $userId, content: $content, isAdmin: $isAdmin, username: $username, fullName: $fullName, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, replyId, postId, userId, content,
      isAdmin, username, fullName, createdAt, updatedAt);
...
abstract class _SupportReplyModel extends SupportReplyModel {
  const factory _SupportReplyModel(
      ...
      required final DateTime updatedAt}) = _$SupportReplyModelImpl;
  const _SupportReplyModel._() : super._();
